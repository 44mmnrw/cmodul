                    ...
                    <tr>
                        <td>
                            <div class="config-cell">
                                ...
                                <div class="config-code">{{ $config->cabinet_id }}</div>
                                <div class="config-description">{{ $config->description ?? 'Нет описания' }}</div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="status-badge status-{{ $config->status_class ?? 'high' }}">{{ $config->status ?? 'Неизвестно' }}</span>
                        </td>
                        <td>
                            <div class="limiting-component">
                                <div class="component-name">{{ $config->limiting_component ?? '-' }}</div>
                                <div class="component-info">Доступно: {{ $config->available ?? '-' }} шт</div>
                                <div class="component-info">Требуется на 1 шт: {{ $config->required ?? '-' }} шт</div>
                            </div>
                        </td>
                        <td class="text-right">
                            <span class="price">{{ $config->unit_price ?? '-' }}</span>
                        </td>
                        <td class="text-right">
                            <span class="price">{{ $config->total_price ?? '-' }}</span>
                        </td>
                    </tr>
                    @empty
                    <tr>
