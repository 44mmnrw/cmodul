...
@section('title', 'Новый производственный заказ')
    ...
    <div class="order-form-card">
        ...
        <form action="{{ route('production-orders.store') }}" method="POST" class="order-form">
            ...
            <div class="form-group-col">
                ...
                <textarea name="notes" class="form-control form-textarea" placeholder="Дополнительная информация о заказе...">{{ old('notes') }}</textarea>
                @error('notes')
                    <span class="form-error">{{ $message }}</span>
                @enderror
            </div>
