...
<div class="detail-form-page">
    ...
    <div class="page-header">
        <div class="page-header-content">
            <a href="{{ route('details.index') }}" class="back-link">
            ...
            <h1 class="page-title">Добавить новую деталь</h1>
        </div>
    </div>

    <!-- Form Card -->
    <div class="card form-card">
        <form action="{{ route('details.store') }}" method="POST" class="detail-form">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                           value="{{ old('name') }}" placeholder="Например: Профиль монтажный 19" 2U"" required>
                    @error('name')
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="scu" name="scu" class="form-control @error('scu') is-invalid @enderror"
                               value="{{ old('scu', 'шт') }}" placeholder="шт, кг, л и т.д." required>
                        @error('scu')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror"
                              placeholder="Подробное описание детали" rows="4">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="width" name="width" class="form-control @error('width') is-invalid @enderror"
                               value="{{ old('width') }}" step="0.01" placeholder="482" required>
                        @error('width')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="height" name="height" class="form-control @error('height') is-invalid @enderror"
                               value="{{ old('height') }}" step="0.01" placeholder="89" required>
                        @error('height')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="depth" name="depth" class="form-control @error('depth') is-invalid @enderror"
                               value="{{ old('depth') }}" step="0.01" placeholder="2" required>
                        @error('depth')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="weight" name="weight" class="form-control @error('weight') is-invalid @enderror"
                               value="{{ old('weight') }}" step="0.01" placeholder="1.2" required>
                        @error('weight')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="material" name="material" class="form-control @error('material') is-invalid @enderror"
                               value="{{ old('material') }}" placeholder="Сталь холоднокатаная">
                        @error('material')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" class="form-control @error('price') is-invalid @enderror"
                               value="{{ old('price') }}" step="0.01" placeholder="420">
                        @error('price')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="price_per_kg" name="price_per_kg" class="form-control @error('price_per_kg') is-invalid @enderror"
                               value="{{ old('price_per_kg') }}" step="0.01" placeholder="350">
                        @error('price_per_kg')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn-submit">Добавить деталь</button>
                <a href="{{ route('details.index') }}" class="btn-cancel">Отмена</a>
            </div>
        </form>
    </div>
</div>
