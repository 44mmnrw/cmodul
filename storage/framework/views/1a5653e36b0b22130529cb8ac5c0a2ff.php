...
<nav class="nav-container">
    <div class="nav-wrapper">
        ...
        <a href="/items" class="nav-button <?php echo e(request()->is('items*', 'places*') ? 'active' : ''); ?>">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/receipts/journal" class="nav-button <?php echo e(request()->is('receipts*') ? 'active' : ''); ?>">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/shipments" class="nav-button <?php echo e(request()->is('shipments*') ? 'active' : ''); ?>">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="<?php echo e(route('production-orders.index')); ?>" class="nav-button <?php echo e(request()->is('production-orders*') ? 'active' : ''); ?>">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
