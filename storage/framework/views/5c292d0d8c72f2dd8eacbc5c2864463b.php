...
<?php $__env->startSection('title', 'Журнал приходов'); ?>
    ...
    <div class="receipts-header">
        <div class="header-content">
            ...
            <div class="header-text">
                <h1>Журнал приходов</h1>
                <p>История всех поступлений компонентов</p>
            </div>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 12%; text-align: center;">Позиций</th>
                        <th style="width: 15%; text-align: center;">Всего единиц</th>
                        <th style="width: 23%;">Примечания</th>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $receipts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr onclick="viewReceipt(<?php echo e($receipt['id'] ?? 0); ?>)" style="cursor: pointer;">
                            <td>
                                <span class="cell-primary"><?php echo e($receipt['number'] ?? 'ПР-' . date('Y') . '-000'); ?></span>
                            </td>
                            <td>
                                <div class="date-cell">
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span><?php echo e($receipt['date'] ?? date('d.m.Y')); ?></span>
                                </div>
                            </td>
                            <td style="text-align: center;">
                                <span class="badge blue"><?php echo e($receipt['items_count'] ?? 0); ?></span>
                            </td>
                            <td style="text-align: center;">
                                <span class="badge green">+<?php echo e($receipt['total_quantity'] ?? 0); ?> шт</span>
                            </td>
                            <td>
                                <span style="color: #6b7280;"><?php echo e($receipt['notes'] ?? '—'); ?></span>
                            </td>
                            <td style="text-align: center;">
                                <button class="icon-btn" onclick="viewReceipt(<?php echo e($receipt['id'] ?? 0); ?>); event.stopPropagation();" title="Просмотр">
    ...
    <?php if(count($receipts ?? []) >= 10): ?>
        <div class="pagination-wrapper">
            <div style="text-align: center; color: #6b7280; padding: 20px;">
                Показано <?php echo e(count($receipts)); ?> из <?php echo e($totalOperations); ?> документов
            </div>
        </div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Cmodul\resources\views/receipts/journal.blade.php ENDPATH**/ ?>