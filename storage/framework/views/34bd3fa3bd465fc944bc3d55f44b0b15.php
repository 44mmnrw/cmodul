...
<div class="content-wrapper">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-content">
                ...
                <p class="stat-value"><?php echo e($stats['total_configs'] ?? 0); ?></p>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-content">
                ...
                <p class="stat-value"><?php echo e(number_format($stats['total_cost'] ?? 0, 0, '.', ' ')); ?> ₽</p>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-content">
                ...
                <p class="stat-value stat-value-warning"><?php echo e($stats['low_stock'] ?? 0); ?></p>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-content">
                ...
                <p class="stat-value stat-value-danger"><?php echo e($stats['out_of_stock'] ?? 0); ?></p>
            </div>
    ...
    <div class="card search-filter-card">
        <form method="GET" action="<?php echo e(route('stock.virtual-stock')); ?>" class="search-form">
                    ...
                    <tr>
                        <td>
                            <div class="config-cell">
                                ...
                                <div class="config-code"><?php echo e($config['scu'] ?? 'N/A'); ?></div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="status-badge status-<?php echo e($config['status_class'] ?? 'success'); ?>"><?php echo e($config['status'] ?? 'Неизвестно'); ?></span>
                        </td>
                        <td>
                            <div class="limiting-component">
                                <div class="component-name"><?php echo e($config['limiting_component'] ?? '—'); ?></div>
                                <?php if($config['limiting_component'] !== 'N/A' && $config['limiting_component'] !== null): ?>
                                <div class="component-info">Доступно: <?php echo e($config['limiting_available'] ?? 0); ?> шт</div>
                                <div class="component-info">Требуется на 1 шт: <?php echo e($config['limiting_required'] ?? 1); ?> шт</div>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="text-right">
                            <span class="price"><?php echo e($config['unit_price'] > 0 ? number_format($config['unit_price'], 0, '.', ' ') . ' ₽' : '—'); ?></span>
                        </td>
                        <td class="text-right">
                            <span class="price"><?php echo e($config['total_price'] > 0 ? number_format($config['total_price'], 0, '.', ' ') . ' ₽' : '—'); ?></span>
                        </td>
                    </tr>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Cmodul\resources\views/stock/virtual-stock.blade.php ENDPATH**/ ?>