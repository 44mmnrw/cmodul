...
<?php $__env->startSection('title', 'Статусы производственных заказов'); ?>
...
<div class="statuses-page">
    ...
    <div class="page-header">
        ...
        <div class="header-actions">
            ...
            <a href="<?php echo e(route('production-order-statuses.create')); ?>" class="btn-primary">
                <svg class="btn-icon">
        ...
        <table class="statuses-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="col-name"><?php echo e($status->name); ?></td>
                            <td class="col-color">
                                <div class="color-preview">
                                    <span class="color-box" style="background-color: <?php echo e($status->color); ?>"></span>
                                    <code><?php echo e($status->color); ?></code>
                                </div>
                            </td>
                            <td class="col-description">
                                <?php if($status->description): ?>
                                    <?php echo e(Str::limit($status->description, 50)); ?>

                                <?php else: ?>
                                    <span class="text-muted">-</span>
                                <?php endif; ?>
                            </td>
                            <td class="col-order"><?php echo e($status->sort_order); ?></td>
                            <td class="col-actions">
                            <div class="actions-group">
                                <a href="<?php echo e(route('production-order-statuses.edit', $status)); ?>" class="btn-icon-link" title="Редактировать">
                                    <svg class="btn-icon">
                                        <use xlink:href="#icon-pencil"></use>
                                    </svg>
                                </a>
                                <form action="<?php echo e(route('production-order-statuses.destroy', $status)); ?>" method="POST" class="inline-form" onsubmit="return confirm('Вы уверены?')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Cmodul\resources\views/production-order-statuses/index.blade.php ENDPATH**/ ?>