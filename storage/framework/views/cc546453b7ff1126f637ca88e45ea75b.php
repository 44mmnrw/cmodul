...
<div class="shipments-wrapper">
    ...
    <div class="action-buttons">
        <a href="<?php echo e(route('shipments.create')); ?>" class="btn-new-shipment">
            <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-content">
                ...
                <p class="stat-value"><?php echo e($stats['total_shipments'] ?? 0); ?></p>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-content">
                ...
                <p class="stat-value"><?php echo e($stats['total_quantity'] ?? 0); ?> <span class="unit">шт</span></p>
            </div>
            ...
            <table class="shipments-table">
                ...
                <tbody>
                    ...
                    <tr class="shipment-row" onclick="toggleDetails(this)">
                        <td class="col-doc-number"><?php echo e($shipment['number'] ?? 'ОТ-2025-001'); ?></td>
                        <td class="col-date">
                            <div class="date-cell">
                                <svg class="date-icon" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M9 11H7v2h2v-2zm4 0h-2v2h2v-2zm4 0h-2v2h2v-2zm2-7h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V9h14v11z"/>
                                </svg>
                                <?php echo e($shipment['date'] ?? '28.01.2025'); ?>

                            </div>
                        </td>
                        <td class="col-client">
                            <div class="client-info">
                                <div class="client-name"><?php echo e($shipment['client'] ?? 'ООО "Компания"'); ?></div>
                                <?php if($shipment['address'] ?? false): ?>
                                <div class="client-address"><?php echo e($shipment['address']); ?></div>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="col-quantity">
                            <span class="quantity-badge"><?php echo e($shipment['quantity'] ?? 0); ?> шт</span>
                        </td>
                        <td class="col-amount"><?php echo e(number_format($shipment['amount'] ?? 0, 0, '.', ' ')); ?> ₽</td>
                                ...
                                <table class="details-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo e($item['quantity']); ?> шт</td>
                                            <td class="text-right"><?php echo e(number_format($item['unit_price'], 0, '.', ' ')); ?> ₽</td>
                                            <td class="text-right"><strong><?php echo e(number_format($item['sum'], 0, '.', ' ')); ?> ₽</strong></td>
                                        </tr>
...
<link rel="stylesheet" href="<?php echo e(asset('css/shipments.css')); ?>">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Cmodul\resources\views/shipments/journal.blade.php ENDPATH**/ ?>