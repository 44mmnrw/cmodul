...
<div class="config-detail-wrapper">
    ...
    <div class="config-detail-header">
        ...
        <a href="<?php echo e(route('configurations.edit', $cabinet->id)); ?>" class="btn btn-primary" title="Редактировать конфигурацию">
            <svg class="icon-pencil" style="width: 1.25rem; height: 1.25rem;">
                ...
                <div class="table-wrapper">
                    <table class="components-table">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr <?php if($index === 2): ?> class="row-warning" <?php endif; ?> style="cursor: pointer;" onclick="window.location.href='/places/<?php echo e($component->scu); ?>'">
                                <td>
                                    <span class="component-type-badge <?php echo e($typeClass); ?>"><?php echo e($typeName); ?></span>
                                </td>
                                <td>
                                    <a href="/places/<?php echo e($component->scu); ?>" style="text-decoration: none; color: inherit;">
            ...
            <div class="card config-card">
                ...
                <div class="stats-details">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="stat-value"><?php echo e($cabinet->created_at->format('Y-m-d') ?? '2024-01-25'); ?></span>
                    </div>
                    <div class="stat-row">
