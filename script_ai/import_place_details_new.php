<?php
/**
 * Скрипт импорта связей place_detail из новго CSV
 * Использование: php script_ai/import_place_details_new.php
 */
...
while (($row = fgetcsv($file, 1000, ';')) !== false) {
    ...
    try {
        ...
        $count++;
        echo "✓ Строка {$line}: place_id={$place_id}, detail_id={$detail_id}\n";
